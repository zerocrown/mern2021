...
const action_create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const bank = yield model_1.default.create({
            name,
            nameBank,
            noRekening,
        });
...
const view_edit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const bank = yield model_1.default.findById(id);
        res.render("admin/bank/edit", {
            data: {
                bank,
                option: model_1.BankOptions,
            },
            userName: req.session.user.name,
...
const action_edit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { name, nameBank, noRekening } = req.body;
        yield model_1.default.findByIdAndUpdate(id, { name, nameBank, noRekening }, {
            new: true,
            runValidators: true,
        });
